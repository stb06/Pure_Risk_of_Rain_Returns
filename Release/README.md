...
- CHEF's primary Skills don't slow it.
- CHEF's Sear Skill doesn't briefly stop it.
...
- Glowing Meteorite and Lost Doll aren't normal equipment.
- Bosses may still drop their "removed" boss item.
	- Requires mod that completely removes select items from the game.
...
- Portals and Timed Security Chest aren't removed.
